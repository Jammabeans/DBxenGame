...
receive() external payable {
    ...
    */
    function processKeyPurchase(uint256 maxKeysToPurchase, uint256 _amount) private {
        ...
        require(maxKeysToPurchase > 0, "User must buy at least 1 key");
    ...
    */
    function getKeyPrice() public view returns (uint256) {
        ...
        // If the price is 0, return 0.0000000009 ether, else return the last set price
        if(lastKeyPrice == 0) {
            return 0.0000000009 ether;
        } else {
            return lastKeyPrice;
        }
    }
